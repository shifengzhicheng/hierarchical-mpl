...
ModularityVertexPartition::ModularityVertexPartition(GraphHelper* graph,
...
ModularityVertexPartition* ModularityVertexPartition::create(GraphHelper* graph)
{
  return new ModularityVertexPartition(graph);
}

ModularityVertexPartition* ModularityVertexPartition::create(GraphHelper* graph, vector<size_t> const& membership)
{
