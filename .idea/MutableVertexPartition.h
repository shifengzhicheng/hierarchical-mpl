...
{
  public:
    MutableVertexPartition(GraphHelper* graph,
        vector<size_t> const& membership);
    MutableVertexPartition(GraphHelper* graph);
    virtual MutableVertexPartition* create(GraphHelper* graph);
    virtual MutableVertexPartition* create(GraphHelper* graph, vector<size_t> const& membership);
    ...
    inline GraphHelper* get_graph() { return this->graph; };
