...
class LIBLEIDENALG_EXPORT Optimiser
{
  public:
    ...
    template <class T> T* find_partition(GraphHelper* graph);
    template <class T> T* find_partition(GraphHelper* graph, double resolution_parameter);
...
template <class T> T* Optimiser::find_partition(GraphHelper* graph)
{
...
template <class T> T* Optimiser::find_partition(GraphHelper* graph, double resolution_parameter)
{
